...
past Contributions submitted to the Project. Except for the licenses granted
herein to the Maintainer and recipients of software distributed by the Maintainer,
...
This includes, for the avoidance of doubt, the right for the Maintainer to license
and distribute Your Contributions, and derivative works thereof, **under any
license terms of the Maintainer's choosing**, including copyleft, permissive,
source-available (such as the Functional Source License), commercial, or
proprietary licenses, and to offer the Project — including Your Contributions — as
a paid or hosted service.
...
for that Contribution or Project shall terminate as of the date such litigation is
filed.
...
## 5. Works That Are Not Your Original Creation
...
This Agreement covers all Contributions You have submitted to the Project before
the date You accept it as well as all Contributions You submit after that date.
The Maintainer may assign this Agreement, and the licenses granted under it,
to any successor of the Project (for example, a company formed to continue its
development), without further consent from You.
...
CLA, a bot will comment with instructions. Replying to that comment with the exact
sentence it asks for constitutes your electronic signature and acceptance of this
Agreement, recorded together with your GitHub username and the date. You only need
to sign once; the signature covers all your past and future contributions to the
Project.
